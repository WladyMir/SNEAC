...
@section('title card','Registro de Usuario')
@section('content')
<form method="POST" action="{{ route('register') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="name" type="text" class="form-control{{ $errors->has('labor') ? ' is-invalid' : '' }}" name="labor" placeholder="Ej: Dr, EU, etc." value="{{ old('labor') }}" required autofocus>
